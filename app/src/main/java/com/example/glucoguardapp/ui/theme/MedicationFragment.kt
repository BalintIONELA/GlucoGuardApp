...
import com.example.glucoguardapp.databinding.FragmentMedicationBinding
...
import com.example.glucoguardapp.ui.theme.adapter.MedicationAdapter
...
class MedicationFragment : Fragment() {
    ...
    private fun alarme(medication: Medication){
        ...
        timePickerDialog = TimePickerDialog(requireContext(), {
            ...
            intent.putExtra(AlarmClock.EXTRA_MESSAGE, "Medication time: "+medication.name+" Your dosage is: "+medication.dosage)
